...
export default function Hobbies() {
    ...
    return (
      <section id="hobbies" className="p-8 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {hobbies.map((hobby, index) => (
              <div key={index} className="bg-black bg-opacity-20 p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
